...
from ontolearn.abstracts import AbstractDrill, AbstractScorer
...
from ontolearn.search import AbstractNode, DRILLSearchTreePriorityQueue, RL_State
...
class Drill(AbstractDrill, BaseConceptLearner):
    ...
    def __init__(self, knowledge_base,
                 path_of_embeddings: str, refinement_operator, quality_func: AbstractScorer,
    ...
    def best_hypotheses(self, n=1) -> list:
